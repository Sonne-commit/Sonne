...
from extensions import ConvertionException, APIException, DeclensionByCases
...
def help(message: telebot.types.Message):
    text = 'Чтобы начать работу введите команду боту в формате:\n <имя валюты> ' \
           '<в какую валюту перевести> <количество переводимой валюты. при необходимости воспользуйтесь точкой, а не запятой > \n' \
            'Запросить информацию /help \n' \
...
def get_price(message: telebot.types.Message):
    try:
        ...
        text = f'Цена за {amount} {quote} = {total_base} {base}'
